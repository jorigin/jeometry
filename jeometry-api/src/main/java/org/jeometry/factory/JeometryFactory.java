...
public class JeometryFactory {
	...
	/**
	 * Create an {@link Transform3DMatrix 3D transformation matrix}.
	 * @return an {@link Transform3DMatrix 3D transformation matrix}
	 */
	public static Transform3DMatrix createTransform3DMatrix() {
		// TODO implements createTransform3DMatrix()
		return null;
	}

	/**
	 * Create an {@link Transform3DQuaternion 3D transformation quaternion}.
	 * @return an {@link Transform3DQuaternion 3D transformation quaternion}
	 */
	public static Transform3DQuaternion createTransform3DQuaternion() {
		// TODO implements GeometryFactory.createTransform3DQuaternion()
		return null;
	}
